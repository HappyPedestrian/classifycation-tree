...
import { defineComponent, h, toRefs, inject, unref, provide, ref, resolveComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, normalizeStyle, createBlock, renderSlot, toDisplayString, createCommentVNode, Fragment, renderList, createVNode, Transition, withCtx, TransitionGroup, pushScopeId, popScopeId } from "vue";
...
const _sfc_main$1 = defineComponent({
  ...
  setup(props, context) {
    const nodeData = toRefs(props.nodeData);
    const slots = inject("slots");
    const connectLineOption = unref(inject("connectLineOption"));
    ...
    let nodeConnectLineOption = {};
    if (nodeData.connectLineOption) {
      nodeConnectLineOption = __spreadValues(__spreadValues({}, connectLineOption), unref(nodeData.connectLineOption));
    } else {
      nodeConnectLineOption = connectLineOption;
    }
    provide("slots", slots || context.slots);
    provide("connectLineOption", nodeConnectLineOption);
    return {
      slots,
  ...
  methods: {
    bindMutationObserver() {
      ...
      const childNodesBoxRef = this.$refs.childNodesBoxRef;
      if (childNodesBoxRef) {
        this.mutationObserver = createMutationObserver(childNodesBoxRef, () => {
          this.$nextTick(() => {
            setTimeout(() => {
              this.mutationObserverCallback();
            }, 500);
...
const _withScopeId = (n) => (pushScopeId("data-v-7696d68a"), n = n(), popScopeId(), n);
    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", {
        ...
        _ctx.slots && _ctx.slots[_ctx.nodeData.slotScope || "default"] ? (openBlock(), createBlock(_component_TemplateContainer, {
          ...
          data: { node: _ctx.nodeData, parent: _ctx.parent }
...
var ClassifyTreeNode = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-7696d68a"]]);
...
var ClassifyTree = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-426dbd21"]]);
